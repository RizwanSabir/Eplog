        ...
        <div
            ...
            <div className="grid grid-cols-4  w-full">
                {properties.map((property, index) => (
                    <div onClick={handleClickItem} key={index} className="  rounded-3xl shadow-[5px_4px_44px_#00000017] w-[200px] overflow-hidden md:w-full mb-9 relative " style={{ width: "272px" }}>
