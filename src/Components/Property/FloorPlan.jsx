            ...
            <div key={id} className="flex mb-8">
              ...
              <div className="w-10/12" onClick={() => setSelectedPlan(plan)}>
                {imgUrl && imgUrl.length > 0 && (
                  <img src={imgUrl[0]} alt={title || 'Floor Plan'} className="w-full h-auto cursor-pointer" />
                )}
              </div>
      ...
      {selectedPlan && (
        ...
        >
          <div className="relative">
            <button
              onClick={closeModal}
              className="absolute text-white text-[100px] font-bold "
            >
              &times;
            </button>
            <img
              src={selectedPlan.imgUrl[0]}
