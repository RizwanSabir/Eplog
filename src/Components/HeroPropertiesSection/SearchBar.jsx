...
const SearchBar = () => {
    ...
    return (
        <>
            <div className='flex justify-center mt-5 mx-20 z-20 '>
                <div className='bg-white relative w-[500px] h-[45px] rounded-full overflow-hidden flex '>
                    ...
                    <div className='flex justify-end w-full'>
                        <h1 className='bg-[#82DFDF] rounded-full px-4 py-1 my-1 mr-2 cursor-pointer' onClick={handleSearch} >Search</h1>
                        <h1 className={`rounded-full px-4 py-1 my-1 cursor-pointer ${UseFilter ? 'hidden' : ''}`} onClick={() => setShowModal(true)}>More Filters</h1>
                    </div>
                </div>
            </div>
            ...
            {showModal && (
                ...
                className="fixed inset-0 z-30 flex justify-center items-center bg-gray-800 bg-opacity-50">
                    <div className="bg-white p-6 rounded-lg shadow-lg w-[800px] z-50">
                        ...
                        <div className="grid grid-cols-3 gap-x-2 ">
                            ...
                            <div>
                                <label>Name</label>
                                <input
                                    className="w-full px-2 py-1 border rounded text-[#bebec0] outline-none"
                                    type="text"
                                    placeholder="Name"
    ...
    return (
        ...
        >
            ...
            <div className='relative '>
                <div
                    className={`w-full text-left px-2 py-1 border rounded cursor-pointer  ${selectedDevelopers.length >= 1 ? 'overflow-x-scroll' : ''}`}
                ...
                {isDropdownOpen && (
                    <div className=''>
                        <div className="mt-2 text-black bg-white absolute border  z-50 rounded w-full text-left  h-[200px] flex flex-col   
                        ">
